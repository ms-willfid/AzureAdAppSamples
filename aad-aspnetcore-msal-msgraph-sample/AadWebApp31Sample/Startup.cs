...
namespace AadWebApp31Sample
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            var CookieSignInScheme = $"AzureAd.{Guid.NewGuid().ToString()}";
            services.AddAuthentication(options =>
            {
                options.DefaultScheme = CookieSignInScheme;
                options.DefaultChallengeScheme = AzureADDefaults.OpenIdScheme;
            })
                .AddCookie(CookieSignInScheme)
                .AddAzureAD(options => Configuration.Bind("AzureAd", options));

            services.Configure<OpenIdConnectOptions>(AzureADDefaults.OpenIdScheme, options =>
            {
                options.SignInScheme = CookieSignInScheme;
                ...
                options.Events.OnAuthorizationCodeReceived = async context =>
                {
                    ...
                    var AccessToken = await tokenAcquisition.GetTokenUsingAuthorizationCode(code);
